          ...
          <div className="">
            ...
            hardware, software, networks, and servers.
              ...
              <motion.div
                ...
                initial="hidden"
                variants={container}
                className=" grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5  gap-5  max-sm:flex-col max-md:mt-10 max-md:max-w-full  "
              >
                {services.map((service) => (
                  <motion.div
                    variants={item}
                    key={service.title}
                    className="flex flex-col flex-1 py-12 bg-white rounded-xl shadow-sm md:px-5 max-sm:py-2 hover:gradient hover:bg-opacity-50 hover:text-zinc-50 max-sm:px-3 "
                  >
                    <Image
                      src={service.image}
                ...
                <motion.div
                  variants={item}
                  className="flex flex-row-reverse px-5 py-2 flex-1 items-center justify-between  xl:flex-col xl:flex-1 xl:pb-11 bg-white rounded-xl shadow-sm hover:gradient hover:bg-opacity-50 hover:text-zinc-50 "
                >
