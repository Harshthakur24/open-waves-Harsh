...
export function Hero() {
  ...
  return (
    <div className="flex  justify-center items-center px-4 xl:px-12 pt-12 w-full max-md:max-w-full bg-gradient-to-r from-red-200 via-purple-50 to-blue-200">
      <div className="-z-10 bg-white">
        <svg viewBox="0 0 500 200">
          <path d="M 0,100 C 150,200 350,0 500,100 L 500,00 L 0,0"></path>
        </svg>
      </div>
      <div className="justify-center pb-12 mt-10 max-w-full border-b border-solid border-b-zinc-300 w-[1545px]  max-md:mt-10">
        <div className="flex flex-col xl:flex-row gap-3 max-md:gap-0 max-md:">
          <div className="flex flex-col xl:w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col xl:mt-11 w-full font-medium max-md:mt-10 max-md:max-w-full">
              ...
              <motion.div
                ...
                className="mt-7 text-5xl lg:text-7xl xl:tracking-tighter text-neutral-800 max-md:max-w-full max-md:text-xl max-md:leading-10"
              >
                Seamless IT for your business, boosting your growth.
              </motion.div>
              <div className="mt-5 lg:mt-11 text-xl lg:text-2xl leading-10 text-neutral-800 max-md:mt-10 max-md:mr-1.5 max-md:max-w-full max-sm:text-lg">
                We provide the expertise and support to propel your business
                forward in the digital landscape.
              </div>
              <div className="flex gap-4 self-start mt-4 lg:mt-9 text-lg leading-7 ">
          ...
          <div className="flex flex-col xl:ml-5 xl:w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col max-md:max-w-full">
              <motion.div
                animate="show"
                variants={container}
                initial="hidden"
                className="grid grid-cols-2 relative items-center pt-10 xl:pt-20 xl:pl-12 w-full max-md:pr-0 max-md:max-w-full max-sm:pt-2 max-sm:min-h-[1px]"
              >
                <motion.div
                  variants={item}
